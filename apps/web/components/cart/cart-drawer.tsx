...
import { useCartStore, selectCartTotal, selectCartCount } from '@/src/store/cart.store';
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4">
          {items.length === 0 ? (
            <div className="text-center text-gray-400 py-16">
              ...
              <Link href="/shop/search" onClick={() => setOpen(false)} className="mt-4 inline-block text-indigo-600 hover:underline text-sm">Explorar productos</Link>
            </div>
          ) : (
            items.map((item) => (
